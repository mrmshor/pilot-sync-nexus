  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className={`w-full px-4 h-10 rounded-2xl text-sm font-medium transition-all duration-200 ${currentStatus.color} border-2 shadow-md hover:shadow-lg active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-blue-500/50 flex items-center justify-between`}
      >
